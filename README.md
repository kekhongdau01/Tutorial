...
![bag of word](https://i.ibb.co/Zz4GrZR/Bow.png)

This is our pipeline for the preparation step:

![Pipeline](https://i.ibb.co/w4hc4wK/Pipeline.png)
...
### Save/load model and implement the chat
After complete all the function part, now it time to do the main function, where we collect the input and combine all the function above to provide the best answer.
...
# Introduction and collect the input
bot_name = "FiveFat"
...
while True:
    ...
    if prob.item() > 0.75: #Check the similarities
        for intent in intents['intents']:
            if tag == intent["tag"]:
                print(f"{bot_name}: {random.choice(intent['responses'])}")
    else: # If the sentence do not meet 75%, the sentence is not already in our dataset
